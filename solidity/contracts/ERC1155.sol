...
abstract contract ERC1155 is ERC165, IERC1155 {
    ...
    */
    ...
    function onTokenTransfer(uint256 _tokenId, address _from, address _to, uint256 _value) internal virtual;

    // Subclasses of this token may want to send additional logs through the centralized Augur log emitter contract
    function onMint(uint256 _tokenId, address _target, uint256 _amount) internal virtual;

    // Subclasses of this token may want to send additional logs through the centralized Augur log emitter contract
    function onBurn(uint256 _tokenId, address _target, uint256 _amount) internal virtual;
}
